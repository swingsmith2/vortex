...
contract ENSRegistry is ENS {
     ...
     * @param owner The address of the new owner.
     */
    function setOwner(bytes32 node, address owner) public override{
     ...
     * @param owner The address of the new owner.
     */
    function setSubnodeOwner(bytes32 node, bytes32 label, address owner) public override returns(bytes32) {
     ...
     * @param resolver The address of the resolver.
     */
    function setResolver(bytes32 node, address resolver) public override{
     ...
     * @param ttl The TTL in seconds.
     */
    function setTTL(bytes32 node, uint64 ttl) public override{
