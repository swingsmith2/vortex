...
contract ERC20Token is ERC20, ERC20Burnable, ERC20Permit, Pausable {
    constructor(uint256 initialSupply, string memory _name, string memory _symbol, uint8 _decimals) ERC20(_name, _symbol, _decimals) {
