...
@dev Withdraw a deposit from the contract. `proof` is a zkSNARK proof data, and input is an array of circuit public inputs
  ...
  */
    function withdraw(bytes calldata _proof, bytes32 _root, bytes32 _nullifierHash, address  _recipient, address  _relayer, uint256 _fee, uint256 _refund) external payable nonReentrant {
        ...
        _processWithdraw(payable(_recipient), payable(_relayer), _fee, _refund);
...
contract TornadoCash_erc20 is Tornado {
    ...
    constructor(
        ...
        address _token,
        address _hasher
    ) Tornado(_verifier, _denomination, _merkleTreeHeight, _operator, _hasher) {
        token = _token;
    }
