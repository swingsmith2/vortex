...
contract EnsResolve {
    function resolve(bytes32 node) public view virtual returns (address) {
        ...
        ENS Registry = ENS(address(0x8F4ec854Dd12F1fe79500a1f53D0cbB30f9b6134));
...
contract FeeManager is EnsResolve {
   ...
   */
    function calculatePoolFee(ITornadoInstance _instance) public view returns (uint160) {
        ...
        token = token == IERC20(address(0)) && !isERC20 ? IERC20(UniswapV3OracleHelper.WETH) : token; // for eth instances
